...
html5countrymapv4.12 - trial version
        ...
        var e,
            ...
            p = (function () {
                    ...
                    (n = t + a + r),
                        ...
                        e.isPlaying() &&
                            (i
                                ...
                                : ((e._scheduleId = _(e._timeoutHandler, 1e3 / 60)), h(e, "beforeTween"), o < t + a ? d(1, l, c, m, 1, 1, u) : d(o, l, c, m, r, t + a, u), h(e, "afterTween"), p(l, e._attachment, n)));
                }
                function v(e, t) {
                    var o = {},
                        i = typeof t;
                ...
                return (
                    ...
                    m(y, { now: s, each: c, tweenProps: d, tweenProp: _, applyFilter: h, shallowCopy: m, defaults: p, composeEasingObject: v }),
                    ...
                    (a = n),
                        ...
                        t.each(r, function (e) {
                            var t = r[e].chunkNames,
                                o = t.length,
                                i = a[e];
                            if ("string" == typeof i) for (var n = i.split(" "), s = n[n.length - 1], l = 0; l < o; l++) a[t[l]] = n[l] || s;
                ...
                i
                    ...
                    : (o.push({ fn: e, ctx: t }),
                      "complete" === document.readyState || (!document.attachEvent && "interactive" === document.readyState)
                          ? setTimeout(a, 1)
                          : n ||
                            (document.addEventListener ? (document.addEventListener("DOMContentLoaded", a, !1), window.addEventListener("load", a, !1)) : (document.attachEvent("onreadystatechange", r), window.attachEvent("onload", a)),
                            (n = !0)));
            };
        })("docReady", t),
        (function (e, t, o) {
    ...
    var o = (function () {
            ...
            return {
                ...
                findPos: function (e) {
                    ...
                    for (var i, n, a = (i = 0), r = e, s = !1; (r = r.parentNode) && r != document.body; ) (a -= r.scrollLeft || 0), (i -= r.scrollTop || 0), "fixed" == t(r, "position") && (s = !0);
                    if (s && !window.opera) {
                        var l =
        ...
        u = {
            ...
            copy: function () {
                var e = { mapdata: o.clone(this.mapdata), mapinfo: o.clone(this.mapinfo), hooks: o.clone(this.hooks), plugin_hooks: o.clone(this.plugin_hooks), copy: this.copy, load: p };
                return c.push(e), e;
            },
            create: function () {
                var t = {
    ...
    function p() {
            ...
            var me,
                ...
                Gt = function (e, t) {
                    if (e) {
                        ...
                        if ((Rt.hide(), Vo(e))) e.sm.ignore_hover || e.animate(e.sm.attributes, D, n), e.animate(e.sm.adjacent_attributes, D, n), Qo(e, "out", !0);
                        else {
                            if (ie && "location" == e.sm.type && "image" == e.sm.shape_type) return;
                            if (!e || !e.sm) return;
                            e.sm.ignore_hover || (i ? (e.attr(e.sm.attributes), n()) : e.animate(e.sm.attributes, D, n)), Qo(e, "out");
                        }
                    } else t();
                    function n() {
                        o.isFunction(t) && t();
                ...
                no = function (e) {
                    var t = e.sm.type;
                    "state" == t && uo("over_state", [e.sm.id]), "location" == t && uo("over_location", [e.sm.id]), "region" == t && uo("over_region", [e.sm.id]);
                },
                ao = function (e) {
                    var t = e.sm.type;
                    "state" == t && uo("out_state", [e.sm.id]), "location" == t && uo("out_location", [e.sm.id]), "region" == t && uo("out_region", [e.sm.id]);
                },
                ro = function (e, t) {
                    var o = e.sm.type;
                    "state" == o && uo("click_state", [e.sm.id, t]), "region" == o && uo("click_region", [e.sm.id, t]), "location" == o && uo("click_location", [e.sm.id, t]);
                },
                so = function (e, t) {
                    var o = e.sm.type;
                    "state" == o && uo("preclick_state", [e.sm.id, t]), "region" == o && uo("preclick_region", [e.sm.id, t]), "location" == o && uo("preclick_location", [e.sm.id, t]);
                },
                lo = function (e, t) {
                    var o = e.sm.type;
                    "state" == o && uo("zoomable_click_state", [e.sm.id, t]), "region" == o && uo("zoomable_click_region", [e.sm.id, t]);
                },
                co = !1,
                mo = ((co = !1), !1);
            mo = !1;
        ...
        function po() {
            (C = !(!_.background_image_url || "no" == _.background_image_url) && _.background_image_url),
                ...
                (O = _.zoom_increment ? _.zoom_increment : 2),
                (B = "no" != _.zoom_mobile),
        ...
        function fo(e) {
            if (
                ((he.style.width = ""),
                (fe.style.width = ""),
                b ? ((be = he.offsetWidth) < 1 && (be = he.parentNode.offsetWidth), (fe.style.width = be + "px")) : ((be = void 0 === _.width ? 800 : _.width), (he.style.width = be + "px")),
                (be *= 1),
                n.calibrate ? (((Me = {}).x = -1 * n.calibrate.x_adjust), (Me.y = -1 * n.calibrate.y_adjust), (Me.x2 = Me.x + n.calibrate.width), (Me.y2 = (Me.x2 - Me.x) / n.calibrate.ratio)) : (Me = n.initial_view),
                (ke = Me.x2 - Me.x),
                (ze = Me.y2 - Me.y),
                (xe = be / (Ce = ke / ze)),
                (Ee = ke / 1e3),
            ...
            if (r)
                if (location.hostname.match("simplemaps.com")) r = !1;
                    ...
                    (Nt.style.cssText =
                        ...
                        _e.appendChild(Nt),
                        (Nt.innerHTML =
                            '<a style="overflow: visible !important; clip-path: none !important; opacity: 1 !important;  filter: opacity(1) !important; transform: none !important; display: block !important; visibility: visible !important; font: 18px Verdana, Arial, Helvetica, sans-serif !important; cursor: pointer !important; font-weight: bold !important; float: right !important; color: #000000 !important; text-decoration: none !important;" ></a>')//,
                       // 503 != Nt.innerHTML.length && (_e.innerHTML = "");
                }
        }
        function yo() {
            var t,
            ...
            !(function () {
                ...
                function _() {
                    if (c) {
                        ...
                        Xe = Raphael(de, s, u);
                        var _ = Xe.path(m.rounded_box).attr({ fill: r, "stroke-width": 1, stroke: l, "stroke-opacity": h, "fill-opacity": 0, cursor: "pointer" }),
                            b = { stroke: l, "stroke-width": 1.5, "stroke-opacity": 1, fill: r, "fill-opacity": 1, cursor: "pointer" },
                        ...
                        g &&
                            (function () {
                                ...
                                var t = m.plus,
                                    o = m.minus,
                                    r = m.rounded_box,
                                    s = Je.path(r).attr({ fill: i, "stroke-width": 1, stroke: n, "stroke-opacity": 1, "fill-opacity": a, cursor: "pointer" }),
                                    l = Je.path(t).attr({ "stroke-width": 0, "stroke-opacity": 0, fill: n, "fill-opacity": 1, opacity: 1, cursor: "pointer" });
                                (Ze = Te.set()).push(s, l);
                                var c = "S" + y + "," + y + ",0,0 T0,0";
                                Ze.transform(c);
                                var u = Je.path(r).attr({ fill: i, "stroke-width": 1, stroke: n, "stroke-opacity": 1, "fill-opacity": a, cursor: "pointer" }),
                                    p = Je.path(o).attr({ "stroke-width": 0, "stroke-opacity": 0, fill: n, "fill-opacity": 1, opacity: 1, cursor: "pointer" });
                                (Ge = Te.set()).push(u, p);
                                ...
                                function _(e, t) {
                                    if ((void 0 === t && (t = "z"), z && "region" != z.sm.type))
                                        ...
                                        pt && (((vt = { sm: { type: "manual", zp: 1 } }).sm.zooming_dimensions = dt), (vt.sm.bbox = { x: dt.x / we, y: dt.y / we, width: dt.w / we, height: dt.h / we }));
                                        var i = (function (e, t) {
        ...
        function go() {
            ...
            !(function () {
                ...
                for (var n in E) for (var a in ((it[n] = Object.create(e)), E[n].url && (it[n].zoomable = !1), E[n])) "default" != E[n][a] && (it[n][a] = E[n][a]), "yes" == E[n][a] && (it[n][a] = !0), "no" == E[n][a] && (it[n][a] = !1);
            })(),
                (function () {
                    for (var e in ((lt = function (e) {
                        ...
                        "us" != a || !H || ("VT" != e && "NJ" != e && "DE" != e && "DC" != e && "NH" != e && "MA" != e && "CT" != e && "RI" != e && "MD" != e) || (tt[e].hide_label = "yes"),
                        d[e]))
                            "default" != d[e][n] && (tt[e][n] = d[e][n]), "yes" == d[e][n] && (tt[e][n] = !0), "no" == d[e][n] && (tt[e][n] = !1);
                ...
                (function () {
                    ...
                    var t = "no" == _.import_labels ? {} : n.default_labels,
                        o = function (o) {
                            for (var i in ((rt[o] = Object.create(e)), t[o])) "default" != t[o][i] && (rt[o][i] = t[o][i]), "yes" == t[o][i] && (rt[o][i] = !0), "no" == t[o][i] && (rt[o][i] = !1);
                        },
                        i = function (t) {
                            for (var o in (rt[t] || (rt[t] = Object.create(e)), q[t])) "default" != q[t][o] && (rt[t][o] = q[t][o]), "yes" == q[t][o] && (rt[t][o] = !0), "no" == q[t][o] && (rt[t][o] = !1);
                        };
                    for (var a in t) o(a);
                    for (var a in q) i(a);
                    ct = function (e) {
                    ...
                    st)) {
                        for (var n in ((ot[i] = Object.create(e)), st[i]))
                            "overwrite_image_location" != n
                                ? ("region" == n && (ot[i].display = "region"), "default" != st[i][n] && (ot[i][n] = st[i][n]), "yes" == st[i][n] && (ot[i][n] = !0), "no" == st[i][n] && (ot[i][n] = !1))
                                : (ot[i].image_url = st[i][n]);
                        ot[i].hover_opacity || (ot[i].hover_opacity = ot[i].opacity), ot[i].hover_color || (ot[i].hover_color = ot[i].color);
                    }
                })(),
                (function () {
                    var e = {};
                    ...
                    for (var o in t) for (var n in ((mt[o] = Object.create(e)), t[o])) "default" != t[o][n] && (mt[o][n] = t[o][n]), "yes" == t[o][n] && (mt[o][n] = !0), "no" == t[o][n] && (mt[o][n] = !1);
                })();
        }
        function bo(e, t) {
            if ("lambert" == n.proj)
                var i = function (e) {
                    var t = 0.017453293,
                        ...
                        n = e.lng * t,
                        a = 33 * t,
                        r = Math.log(Math.cos(a) * (1 / Math.cos(0.785398185))) / Math.log(Math.tan(0.25 * o + 0.3926990925) * (1 / Math.tan(0.25 * o + 0.5 * a))),
            ...
            function r(e) {
                var t,
                    ...
                    d = [0, 0.0838426, 0.1676852, 0.2515278, 0.3353704, 0.419213, 0.5030556, 0.5868982, 0.67182264, 0.75336633, 0.83518048, 0.91537187, 0.99339958, 1.06872269, 1.14066505, 1.20841528, 1.27035062, 1.31998003, 1.3523];
                return { x: ((p[m] - p[c]) * u + p[c]) * r * 0.017453293 * n * 1, y: ((d[m] - d[c]) * u + d[c]) * a * 1 };
            }
            ...
            function l(e, t, n, a) {
                var r,
                    ...
                    S =
                        ...
                        { opt1: { x: (h = r + (g * _) / d) + (v = ((f = Math.sqrt(l * l - _ * _)) / d) * -p), y: b + (y = g * (f / d)) }, opt2: { x: h - v, y: b - y } }),
                    B = o.distance(x, z) / A;
                return Math.abs(o.distance(S.opt1, a) - B) < Math.abs(o.distance(S.opt2, a) - B) ? { x: S.opt1.x, y: S.opt1.y } : { x: S.opt2.x, y: S.opt2.y };
            }
            function c(e, t, i) {
        ...
        function xo(e) {
            ...
            var t,
                ...
                c = ke * we,
                m = ze * we;
            return (n -= 0.5 * (r / l - r)), (a -= 0.5 * (s / l - s)), (r /= l) / (s /= l) > Ce ? ((a -= (m * (t = r / c) - s) / 2), (s = r / Ce)) : ((n -= (c * (t = s / m) - r) / 2), (r = s * Ce)), { x: n, y: a, w: r, h: s, r: t };
        }
        function wo(e) {
            if (e) {
                He.stop();
            ...
            Ue.hide(),
                (function (e, t) {
                    We.hide(),
                        We.forEach(function (o) {
                            o.sm.hide || (Mo(o, e) && o.show(), o.sm.scale && Eo(o, qo(o, (Ae > o.sm.scale_limit ? Ae : o.sm.scale_limit) * we), t));
                        });
                })(e, t),
                (function (e, t) {
                ...
                "out" != i && "manual" != i
                    ? (He.stop(),
                      ...
                      e.animate({ "stroke-width": e.sm.border_hover_size * (be / ke) * Ee * 1.25 }, 1e3 * S))
        ...
        function Co(e) {
            if (w && "-1" != x && "region" == e.sm.type) {
                if (!j) return;
                Ue.show();
            } else "state" == e.sm.type || "region" == e.sm.type || j ? Ue.show() : g && "out" != e.sm.type && Ue.show();
        }
        function To(e) {
        ...
        function Bo(i, n, a) {
            if (!Dt) {
                ...
                if (((Ae = i.sm.zooming_dimensions.r), Ao(i, n), ie || (me && !B) || n)) (dt = r), Te.setViewBox(r.x, r.y, r.w, r.h, !1), c();
                else {
            ...
            function c() {
                Co(i), (vt = i), (Dt = !1), (re = !1), (e.zoom_level = vt.sm.type), (e.zoom_level_id = !!vt.sm.id && vt.sm.id), uo("zooming_complete", []), o.isFunction(a) && a();
            }
        }
        function Oo(e) {
            var t = "",
            ...
            return (t = t.substring(0, t.length - 1)), (t += "}"), e || 
        }
        function Fo(e) {
            ...
            return (
                Raphael._preload(t.image_url, function () {
                    ...
                    var n,
                        ...
                        r = (function () {
                            var n = t.image_size;
                            return f ? (v || g ? (n = i > 1 ? (e > w ? 1 : e / w) : o > k ? 1 / z : o / k / z) : b && ((n = i / z), (n = i > z ? n : 1 / n))) : n > 1 && (n = (t.image_size * Ee) / w), n;
                        })(),
                        s = w * r,
                        l = s / i,
                        c = 0,
                        u = 0;
                    if (
                        (v ? ((n = r), (a = (r * z) / i)) : g ? ((n = 1), (a = 1), (c = t.image_x * w), (u = t.image_y * k)) : b && ((n = 1), (a = 1), (c = 0.5 * (w - s)), (u = 0.5 * (k - l))),
                        d.setAttribute("x", 0),
                        d.setAttribute("y", 0),
        ...
        function Ro(e) {
            ...
            for (var o in ((_t = function (e) {
                ...
                var s = { fill: i.color, opacity: i.opacity, stroke: i.border_color, cursor: "pointer", "stroke-opacity": 1, "stroke-width": t, "stroke-linejoin": "round" },
                ...
                i.inactive && (s.cursor = "default"),
                    ...
                    (i.border_hover_color || i.border_hover_size) && i.emphasize ? (r.sm.emphasizable = !0) : (r.sm.emphasizable = !1),
        ...
        function No(e) {
                    ...
                    if (!e) {
                        ...
                        for (var r = [], s = 0; s < n.states.length; s++) {
                            ...
                            c
                                ? c.sm.region
                                    ? 
                                    : ((c.sm.region = t), a.sm.states.push(l), (ie && c.sm.ignore_hover && (i.color || i.hover_color)) || a.push(c), r.push(c.sm.bbox))
                                : 
                        }
            ...
            if (!e) {
                ...
                if (
                    ...
                    (vt = p),
                    "object" == typeof x
                        ? (((yt = {}).sm = { type: "manual", zp: 1, bbox: x }), (yt.sm.zooming_dimensions = xo(yt)), (x = -1), (w = !1))
                        : -1 == x || x in ft || (x in ht ? ((Vt = ht[x]), (w = !1)) : 
                    v)
                ) {
                    ft[-2] = {};
                    var _ = ft[-2];
        ...
        function Lo(e) {
            ...
            var i = 0.5 * t.width,
                n = 0.5 * t.height,
                a = e.sm.point0;
            return { x: a.x - i, y: a.y - n, x2: a.x + i, y2: a.y + n, width: t.width, height: t.height };
        }
        function Do() {
            ...
            (xt = function (e) {
                ...
                if (rt.hasOwnProperty(e)) {
                    var r = !gt[e],
                        ...
                        m = !1,
                        u = !1;
                    if (("state" == t.parent_type ? (m = ht[t.parent_id]) : "region" == t.parent_type ? (m = ft[t.parent_id]) : "location" == t.parent_type && (m = kt[t.parent_id]), !t.x && !t.y && m))
                    ...
                    if ((t.parent_type, m)) {
                        ...
                        (v.sm = {}), (v.sm.hide = t.hide), m && (m.sm.hide_label || m.sm.hide) && (v.sm.hide = !0), (v.sm.parent = m), m.sm.labels.push(v), m.sm.region && ft[m.sm.region].sm.labels.push(v);
                        var y = { "stroke-width": 0, fill: t.color, "font-size": t.size, "font-weight": "bold", cursor: "pointer", "font-family": t.font_family, "text-anchor": t.anchor, opacity: t.opacity },
                        ...
                        if (t.line) {
                            var H = Ho(v),
                                ...
                                Y = { stroke: t.line_color, cursor: "pointer", "stroke-width": W };
                            q.attr(Y), (q.sm = {}), (q.sm.type = "label"), (v.sm.pill = !1), (q.sm.size = t.line_size), (q.sm.id = e), (v.sm.line = q), Se.push(q), s.push(q);
                        }
                        if ("state" == m.sm.type && t.pill) {
                            ...
                            if (
                                ...
                                (J.sm.bbox = o.bbox_union([J.sm.bbox, v.sm.bbox])), (J.sm.zooming_dimensions = !1), (J.sm.zooming_dimensions = xo(J));
                            }
                            (v.sm.pill = G), De.push(G), s.push(G), s.push(v);
                        } else s.push(v);
                        if (
                            (("out" != v.sm.display && "all" != v.sm.display) || v.sm.hide ? s.hide() : Ie.push(s),
                            "location" != v.sm.parent.sm.type || v.sm.line || Oe.push(s),
                            Qe.push(s),
                            (bt[e] = s),
        ...
        function Ho(e) {
            ...
            var d = { x: l, y: c },
                _ = [];
            _.push({ x: t.x2 - r, y: 0.5 * (t.y + t.y2) }), _.push({ x: t.x + r, y: 0.5 * (t.y + t.y2) }), _.push({ x: 0.5 * (t.x + t.x2), y: t.y + s }), _.push({ x: 0.5 * (t.x + t.x2), y: t.y2 - s });
            var h = {};
            for (var f in _) {
                var v = _[f],
                    y = o.distance(v, d);
        ...
        function Wo(e) {
            ...
            (zt = function (e) {
                var t = "center",
                    n = ot[e];
                if ("image" != n.type)
                    var a = { "stroke-width": n.border * we * Ee, stroke: n.border_color, fill: n.color, opacity: n.opacity, cursor: "pointer" },
                        r = { "stroke-width": n.hover_border * we * Ee, stroke: n.border_color, fill: n.hover_color, opacity: n.hover_opacity, cursor: "pointer" };
                else {
                    t = n.image_position;
                ...
                if ("circle" == s)
                    var _ = Te.circle(u.x, u.y, 0.5 * l),
                        h = { x: u.x - 0.5 * l * Ae, y: u.y - 0.5 * l * Ae, x2: u.x + 0.5 * l * Ae, y2: u.y + 0.5 * l * Ae };
                ...
                (_.sm.underlay = z),
                    ...
                    We.push(_),
                    (kt[e] = _),
                    ie || _.node.setAttribute("class", "sm_location_" + e) ||  _.node.setAttribute("class", "abc_location_" + e);
            }),
            st))
                zt(t);
        }
        function Yo(t) {
            ...
            return n ? ("out" == o ? n : "region" == o ? (i == n.sm.id ? t : n) : "state" == o ? (ht[i].sm.region === n.sm.id ? t : n) : "manual" == o ? (Ae > n.sm.zooming_dimensions.r || !n.sm.zoomable ? n : t) : void 0) : t;
        }
        function Vo(t) {
            var o = e.zoom_level,
                i = e.zoom_level_id;
        ...
        function Qo(e, t, o, i) {
            e.sm.labels &&
                e.sm.labels.forEach(function (e) {
                    if (e.sm) {
                        var n = e.sm.pill;
                        "over" == t ? (e.stop(), Xt(e, "over"), n && Ut(n, "over")) : ("reset" != t && "out" != t) || (Xt(e, "out"), n && (Ut(n, "out", i), o && Ut(n, "adjacent", i)));
                    }
                });
        }
        function Xo() {
                    ...
                    if (e.sm.pulse || t) {
                        ...
                        if (!("location" != e.sm.type || "image" == o || Ae < 0.05)) {
                            ...
                            var n = 1 * e.sm.pulse_size,
                                a = { "stroke-width": 4 * e.attrs["stroke-width"], "stroke-opacity": 0 };
                ...
                (Et = function (e) {
                    if (!ie || !ne)
                        for (var t = Array.isArray(e) ? e : [e], o = 0; o < t.length; o++) {
                            ...
                            var n = i.clone(),
                                a = 1 * i.sm.pulse_size,
                                r = { "stroke-width": 4 * (i.attrs["stroke-width"] ? i.attrs["stroke-width"] : 1), "stroke-opacity": 0, "fill-opacity": 0 };
            ...
            (Ct = function (o) {
                if (!(Dt || Ht || qt)) {
                    ...
                    if (!i.sm.inactive && (so(i, o), !e.ignore_clicks)) {
                        ...
                        if ((re && Rt.update_pos(), (jt = i.sm.popup_off), !i.sm.zoomable || ("region" != i.sm.type && vt == i && "out" != i.sm.type)))
                            if (re) {
                                if ((z == i || !z || ((c = z), "state" == (l = i).sm.type && "region" == c.sm.type && c.sm.id == l.sm.region) || ("region" != i.sm.type && "region" == e.zoom_level) || Gt(z), ro(i, o), o)) {
                                    var n = Uo(o);
                                    Rt.pos(o, { l: n.x, u: n.y });
                                }
                                Rt.show(i), (M = !0), Qo(i, "over"), Mt(i), (ie && "location" == i.sm.type && "image" == i.sm.shape_type) || i.sm.ignore_hover || i.attr(i.sm.over_attributes), (z = i);
                                ...
                                if ("" != r && !mo) {
                                    ...
                                    return !X || s ? void (s ? (window.location.href = r) : (window.top.location.href = r)) : (window.open(r, "_blank"), void Rt.hide());
                                }
                            }
                        else
                            lo(i, o),
                ...
                (Ft = function (e) {
                    if ((void 0 === e && (e = !1), uo("back", []), ("out" == vt.sm.type || ("region" == vt.sm.type && w)) && j)) window.location.href = "javascript:" + j;
                    else if (V && "state" == vt.sm.type && vt.sm.region)
                        z
                            ? St.call(z, !0, function () {
                                  Bo(ft[vt.sm.region]);
                              })
                            : Bo(ft[vt.sm.region], !1, e);
                    else {
                        var t = Io(vt, ft[x]),
        ...
        function Uo(e) {
            ...
            return { x: ne ? e.clientX + document.documentElement.scrollLeft : e.pageX, y: o };
        }
        function Zo() {
            var e = !1;
            function t(t) {
        ...
        function Jo(e) {
            if (!e) {
                ae ? (He.mouseup(Ct), je.mouseup($t), Ue.mouseup(It), je.mouseup(ri)) : (He.hover(Tt, St), He.click(Ct), je.click($t), Ue.click(It), je.hover(ri, ri)),
                    b &&
                        (function () {
                            function e() {
                                Ko();
                        ...
                        (function () {
                            function e(e) {
                                var o = Uo(e),
                                    ...
                                    l = (n - r) * t.r,
                                    c = 5 * t.r;
                                return (Math.abs(s) > c || Math.abs(l) > c) && (Ht = !0), { x: t.x + s, y: t.y + l, w: t.w, h: t.h, r: t.r };
                            }
                            var t,
                                i,
                                n,
                            ...
                            function r(e) {
                                if (M) return !1;
                                e.preventDefault ? e.preventDefault() : (e.returnValue = !1), (t = { x: dt.x, y: dt.y, w: dt.w, h: dt.h, r: dt.w / ke / we }), (a = !0);
                                var o = Uo(e);
            ...
            if (!(he.offsetWidth < 1)) {
                ...
                He &&
                    ...
                    (He.forEach(function (t) {
                        t.attr({ "stroke-width": e }), (t.sm.attributes["stroke-width"] = e), (t.sm.over_attributes["stroke-width"] = t.sm.border_hover_size * (be / ke) * Ee * 1.25);
                    }),
        ...
        function ei(e) {
            po(), go(), Ro(!0), No(!0), Wo(), Do(), jo(), Ao(vt, !0), Go(), Jo(!0), Ko(), $o(!0), Co(vt), yi(), io(!0), uo("refresh_complete", []), o.isFunction(e) && e();
        }
        function ti(t) {
            ...
            (function () {
                ...
                : (po(),
                  ...
                  fo(),
                  (function () {
                      if (((Te = Raphael(_e, be, xe)), (je = Te.set()), (Ne = Te.rect(Me.x - 2 * ke, Me.y - 2 * ze, 5 * ke, 5 * ze)), C)) {
                  ...
                  (function () {
                      ...
                      if (s) {
                          ...
                          (o.style.cssText = e), (o.href = "https://simplemaps.com"), (o.title = "Built with with SimpleMaps"), (o.innerHTML = "&copy; Simplemaps.com"), Lt.appendChild(o);
                      }
                  })(),
                  te ||
                      (function () {
                          if (!Wt) {
                              ...
                              (r +=
                                  ...
                                  (r += ".xmark_sm{float: " + (ie ? "left" : "right") + "; margin-left: .5em; cursor: pointer; line-height: 0px; width: 1.3em !important;}"),
                                  o.new_style(r),
                                  (Wt = !0);
                          }
                          function s(e) {
                              for (var t = document.documentElement, o = 0; o < e.length; o++)
                                  if (e[o] in t.style) {
                                      var i = e[o];
                                      return (i = (i = (i = (i = (i = (i = i.replace("borderRadius", "border-radius")).replace("MozBorderRadius", "-moz-border-radius")).replace("WebkitBorderRadius", "-webkit-border-radius")).replace(
                                          "boxShadow",
                                          "box-shadow"
                  ...
                  (Rt = {
                      ...
                      pos: function (e, t) {
                          t ? ((r = t.u), (m = t.l)) : ((r = ne ? event.clientY + document.documentElement.scrollTop : e.pageY), (m = ne ? event.clientX + document.documentElement.scrollLeft : e.pageX)),
                              (r -= j),
                              (m -= R),
                      ...
                      set_pos: function (e, t, o) {
                          if (O) {
                              ...
                              if ((o && o.sm.on_click && ("yes" == I || ("auto" == I && be < 401))) || i) {
                                  ...
                                  if (((B = 0 + 0.5 * xe), t > (S = 0 + 0.5 * be) && e > B)) r = 4;
                                  else if (t < S && e > B) r = 3;
                                  else if (t > S && e < B) r = 2;
                                  else var r = 1;
                                  "below" == P ? (3 == r && (r = 1), 4 == r && (r = 2)) : "above" == P && (1 == r && (r = 3), 2 == r && (r = 4)),
                                      1 == r
                                          ? ((O.style.bottom = "auto"), (O.style.top = e + 5 + "px"), (O.style.left = t + 5 + 5 + "px"), (O.style.right = "auto"))
                                          : 2 == r
                                          ? ((O.style.bottom = "auto"), (O.style.top = e + 5 + "px"), (O.style.right = be - t + 5 + "px"), (O.style.left = "auto"))
                                          : 3 == r
                                          ? ((O.style.bottom = xe - e + 5 + "px"), (O.style.top = "auto"), (O.style.left = t + 5 + 3 + "px"), (O.style.right = "auto"))
                                          : ((O.style.bottom = xe - e + 5 + "px"), (O.style.top = "auto"), (O.style.right = be - t + 5 + "px"), (O.style.left = "auto"));
                              }
                          }
                      },
                      hide: function () {
                  ...
                  setTimeout(function () {
                      Wo(),
                              ...
                              if (e) {
                                  for (var t in e) {
                                      ...
                                      var d = r || o.path,
                                          _ = Te.path(d);
                                      _.transform(Pe),
                                          _.attr({ stroke: n.color, fill: "none", cursor: "pointer", "stroke-dasharray": [n.dash], "stroke-width": a, "stroke-linejoin": "round", "stroke-miterlimit": 4 }),
                                          (_.sm = {}),
                                          (_.sm.size = n.size),
                          ...
                          (function () {
                              ...
                              (c = document.createElement("select")).options.add(new Option(e, "-1")),
                                  c.options.add(new Option("Back", "back")),
                                  c.options.add(new Option("Zoom in", "in")),
                                  c.options.add(new Option("Zoom out", "out")),
                                  c.options.add(new Option("Left", "left")),
                                  c.options.add(new Option("Right", "right")),
                                  c.options.add(new Option("Up", "up")),
                                  c.options.add(new Option("Down", "down")),
                                  (c.style.marginRight = ".5em"),
                              ...
                              var t = void 0 === _.states_title ? "States" : _.states_title,
                                  ...
                                  a = { state: { title: t, array: ht }, location: { title: n, array: kt }, region: { title: i, array: ft } };
                              for (var r in a) {
                                  var s = a[r],
                                  ...
                                  if (!(l < 1 || (l < 2 && "region" == r))) {
                                      ...
                                      (c.onchange = o.callback_closure({ entry: s, dropdown: c }, function (e) {
                                          var t = e.dropdown,
                                              o = e.entry;
                          ...
                          (function () {
                              if (!(!i.legend || !i.legend.entries || i.legend.entries.length < 1 || (ne && ie))) {
                                  var e = {};
                                  (map_legend.style.left = "0em"), (map_legend.style.bottom = "0em"), (map_legend.style.padding = ".8em"), (map_legend.style["background-color"] = ne ? "#ffffff" : "rgba(186, 186, 186, 0.2)");
                                  var t = document.createElement("ul");
                                  (t.style.display = "inline"), (t.style["list-style-type"] = "none"), (t.style.margin = "0"), (t.style.padding = "0"), map_legend.appendChild(t);
                                      ...
                                      : (function () {
                                            for (var e in a) {
                                                ...
                                                if (
                                                    ...
                                                    (r = document.createElementNS("http://www.w3.org/2000/svg", "circle")).setAttribute("cx", "50"), r.setAttribute("cy", "50"), r.setAttribute("r", "40");
                                                else if ("square" == o.shape)
                                                    (r = document.createElementNS("http://www.w3.org/2000/svg", "rect")).setAttribute("x", "10"), r.setAttribute("y", "10"), r.setAttribute("width", "80"), r.setAttribute("height", "80");
                                                else {
                                                    var r,
                                                        s = Qt[o.shape];
                                                ...
                                                ["square", "circle"].indexOf(o.shape) > -1
                                                    ? (r.setAttribute("stroke-width", "10"), n.setAttribute("viewBox", "0 0 100 100"), n.setAttribute("width", "100"), n.setAttribute("height", "100"))
                                                    : ["diamond", "star"].indexOf(o.shape) > -1
                                                    ? (n.setAttribute("viewBox", "-.5 -.6 1 1.2"), n.setAttribute("height", "1.8"))
                                                    : ["triangle"].indexOf(o.shape) > -1
                                                    ? (n.setAttribute("viewBox", "-.6 -.7 1.2 1.1"), n.setAttribute("width", "1.8"), n.setAttribute("height", "1.8"))
                                                    : ["heart"].indexOf(o.shape) > -1
                                                    ? (n.setAttribute("viewBox", "-.7 -.5 1.3 1"), n.setAttribute("width", "2"))
                                                    : ["marker"].indexOf(o.shape) > -1 && (n.setAttribute("viewBox", "-.6 -.9 1.1 .8"), n.setAttribute("width", "1.7"), n.setAttribute("height", "1.7")),
